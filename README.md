...
测试报告：[报告目录](https://alexued.github.io/kaogong-checkin/reports/) · [v0.13.1 Android 与 Windows 发布验收](https://alexued.github.io/kaogong-checkin/reports/v0.13.1/TEST-REPORT.md)
...
| Windows | [kaogong-checkin-windows-x64-setup-v0.13.1.exe](https://github.com/Alexued/kaogong-checkin/releases/download/v0.13.1/kaogong-checkin-windows-x64-setup-v0.13.1.exe) | 106.94 MiB | Windows 10/11 x64 | FC78C351B760C2D9494055870EAB19F2CE42E75B406E975143C7889910A9ADBF |
...
Get-FileHash .\kaogong-checkin-windows-x64-setup-v0.13.1.exe -Algorithm SHA256
```
