...
test('all showcase pages use the v0.15.1 cache key for release and local assets', async () => {
  const pages = [
  ...
  for (const page of pages) {
    ...
    assert.match(page, /release-data\.js\?v=20260817-v0151-release/);
    assert.match(page, /styles?\.css\?v=20260817-v0151-release/);
    assert.match(page, /app\.js\?v=20260817-v0151-release/);
  }
});
